...
int main(int argc, char** argv) {
    ...
    cout<<"Se quiser converter uma operação matemática em notação prefixa e posfixa digite 2"<<endl;
    cout<<"Se quiser encontrar a função Totiente de Euler digite 3"<<endl;
